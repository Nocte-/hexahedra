...
mc( 14,  0, { name = "window.blue", texture = {"window.1"} } )
mc( 15,  0, { name = "window.red", texture = {"window.3"} } )
mc( 16,  0, { name = "ore.coal", texture = {"window.4"} } )
...
mc( 21,  0, { name = "ore.lapiz", texture = {"lapiz"} } )
