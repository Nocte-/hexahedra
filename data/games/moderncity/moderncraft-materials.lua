...
mc(  1,  0, { name = "stone", texture = {"stone"} } )
mc(  2,  0, { name = "grass", texture = {"grass.side", "grass", "dirt"} } )
mc(  3,  0, { name = "dirt", texture = {"dirt"} } )
mc(  4,  0, { name = "cobblestone", texture = {"cobblestone"} } )
mc(  5,  0, { name = "wooden plank", texture = {"wood" } } )
...
mc(  8,  0, { name = "water (level 0)", texture = {"water"}, transparency = 0.8 } )
mc(  8,  1, { name = "water (level 1)", texture = {"water"}, transparency = 0.8 } )
mc(  8,  2, { name = "water (level 2)", texture = {"water"}, transparency = 0.8 } )
mc(  8,  3, { name = "water (level 3)", texture = {"water"}, transparency = 0.8 } )
mc(  8,  4, { name = "water (level 4)", texture = {"water"}, transparency = 0.8 } )
mc(  8,  5, { name = "water (level 5)", texture = {"water"}, transparency = 0.8 } )
mc(  8,  6, { name = "water (level 6)", texture = {"water"}, transparency = 0.8 } )
mc(  8,  7, { name = "water", texture = {"water"}, transparency = 0.8 } )
mc(  8,  8, { name = "water (level 0, falling)", texture = {"water"}, transparency = 0.8 } )
mc(  8,  9, { name = "water (level 1, falling)", texture = {"water"}, transparency = 0.8 } )
mc(  8, 10, { name = "water (level 2, falling)", texture = {"water"}, transparency = 0.8 } )
mc(  8, 11, { name = "water (level 3, falling)", texture = {"water"}, transparency = 0.8 } )
mc(  8, 12, { name = "water (level 4, falling)", texture = {"water"}, transparency = 0.8 } )
mc(  8, 13, { name = "water (level 5, falling)", texture = {"water"}, transparency = 0.8 } )
mc(  8, 14, { name = "water (level 6, falling)", texture = {"water"}, transparency = 0.8 } )
mc(  8, 15, { name = "water", texture = {"water"}, transparency = 0.8 } )
mc(  9,  0, { name = "stationary water (level 0)", texture = {"water"}, transparency = 0.8 } )
mc(  9,  1, { name = "stationary water (level 1)", texture = {"water"}, transparency = 0.8 } )
mc(  9,  2, { name = "stationary water (level 2)", texture = {"water"}, transparency = 0.8 } )
mc(  9,  3, { name = "stationary water (level 3)", texture = {"water"}, transparency = 0.8 } )
mc(  9,  4, { name = "stationary water (level 4)", texture = {"water"}, transparency = 0.8 } )
mc(  9,  5, { name = "stationary water (level 5)", texture = {"water"}, transparency = 0.8 } )
mc(  9,  6, { name = "stationary water (level 6)", texture = {"water"}, transparency = 0.8 } )
mc(  9,  7, { name = "stationary water", texture = {"water"}, transparency = 0.8 } )
mc(  9,  8, { name = "stationary water (level 0, falling)", texture = {"water"}, transparency = 0.8 } )
mc(  9,  9, { name = "stationary water (level 1, falling)", texture = {"water"}, transparency = 0.8 } )
mc(  9, 10, { name = "stationary water (level 2, falling)", texture = {"water"}, transparency = 0.8 } )
mc(  9, 11, { name = "stationary water (level 3, falling)", texture = {"water"}, transparency = 0.8 } )
mc(  9, 12, { name = "stationary water (level 4, falling)", texture = {"water"}, transparency = 0.8 } )
mc(  9, 13, { name = "stationary water (level 5, falling)", texture = {"water"}, transparency = 0.8 } )
mc(  9, 14, { name = "stationary water (level 6, falling)", texture = {"water"}, transparency = 0.8 } )
...
mc( 13,  0, { name = "gravel", texture = {"gravel"} } )
mc( 14,  0, { name = "ore.gold", texture = {"ore.gold"} } )
mc( 15,  0, { name = "ore.iron", texture = {"ore.iron"} } )
mc( 16,  0, { name = "ore.coal", texture = {"ore.coal"} } )
...
mc( 18,  0, { name = "leaves (oak)", texture = {"leaves.oak"}, transparency = 0.8 } )
mc( 18,  1, { name = "leaves (pine)", texture = {"leaves.pine"}, transparency = 0.8 } )
mc( 18,  2, { name = "leaves (birch)", texture = {"leaves.birch"}, transparency = 0.8 } )
mc( 18,  3, { name = "leaves (jungle)", texture = {"leaves.jungle"}, transparency = 0.6 } )
mc( 18,  4, { name = "leaves (permanent, oak)", texture = {"leaves.oak"}, transparency = 0.8 } )
mc( 18,  5, { name = "leaves (permanent, pine)", texture = {"leaves.pine"}, transparency = 0.8 } )
mc( 18,  6, { name = "leaves (permanent, birch)", texture = {"leaves.birch"}, transparency = 0.8 } )
mc( 18,  7, { name = "leaves (permanent, jungle)", texture = {"leaves.jungle"}, transparency = 0.6 } )
mc( 18,  8, { name = "leaves (decaying, oak)", texture = {"leaves.oak"}, transparency = 0.8 } )
mc( 18,  9, { name = "leaves (decaying, pine)", texture = {"leaves.pine"}, transparency = 0.8 } )
mc( 18, 10, { name = "leaves (decaying, birch)", texture = {"leaves.birch"}, transparency = 0.8 } )
mc( 18, 11, { name = "leaves (decaying, jungle)", texture = {"leaves.jungle"}, transparency = 0.6 } )
mc( 18, 12, { name = "leaves (permanent, oak)", texture = {"leaves.oak"}, transparency = 0.8 } )
mc( 18, 13, { name = "leaves (permanent, pine)", texture = {"leaves.pine"}, transparency = 0.8 } )
mc( 18, 14, { name = "leaves (permanent, birch)", texture = {"leaves.birch"}, transparency = 0.8 } )
mc( 18, 15, { name = "leaves (permanent, jungle)", texture = {"leaves.jungle"}, transparency = 0.6 } )
...
mc( 21,  0, { name = "lapis ore", texture = {"ore.lapis"} } )
mc( 22,  0, { name = "lapis", texture = {"lapis"} } )
...
mc( 25,  0, { name = "note block", texture = {"mc.musicblock"} } )
...
mc( 27,  0, { name = "rail.powered.flat.ns", texture = {"rail.ns"}, transparency = 1.0,
    custom_model = { { 7, 0, 0, 9, 15, 0, "plain.yellow" } } } )

mc( 27,  1, { name = "rail.powered.flat.ew", texture = {"rail.ew"}, transparency = 1.0,
    custom_model = { { 0, 7, 0, 15, 9, 0, "plain.yellow" } } } )
...
mc( 30,  0, { name = "cobweb", texture = {"web"}, transparency = 1.0 } )
...
mc( 35,  1, { name = "wool", texture = {"plain.orange"} } )
mc( 35,  2, { name = "wool", texture = {"marble"} } )
mc( 35,  3, { name = "wool", texture = {"plain.blue"} } )
mc( 35,  4, { name = "wool", texture = {"plain.yellow"} } )
mc( 35,  5, { name = "wool", texture = {"window.1"}, transparency = 0.96  } )
mc( 35,  6, { name = "wool", texture = {"leather.red"} } )
mc( 35,  7, { name = "wool", texture = {"plain.gray.dark"} } )
mc( 35,  8, { name = "wool", texture = {"plain.gray"} } )
mc( 35,  9, { name = "wool", texture = {"plain.teal"} } )
mc( 35, 10, { name = "wool", texture = {"plain.red.dark"} } )
mc( 35, 11, { name = "wool", texture = {"leather.blue"} } )
mc( 35, 12, { name = "wool", texture = {"plain.brown"} } )
mc( 35, 13, { name = "wool", texture = {"plain.green.dark"} } )
mc( 35, 14, { name = "wool", texture = {"plain.red"} } )
...
mc( 41,  0, { name = "gold block", texture = {"gold"} } )
mc( 42,  0, { name = "iron block", texture = {"iron"} } )

--
mc( 43,  0, { name = "stone double slabs", texture = {"mc.slab", "mc.slab.top"} } )
mc( 43,  1, { name = "sandstone double slabs", texture = {"mc.slab.sandstone", "sandstone"} } )
mc( 43,  2, { name = "wooden double slabs", texture = {"mc.slab.wood", "wood"} } )
mc( 43,  3, { name = "cobblestone double slabs", texture = {"mc.slab.cobblestone", "cobblestone"} } )
mc( 43,  4, { name = "brick double slabs", texture = {"mc.slab.brick.red"} } )
mc( 43,  5, { name = "stone brick double slabs", texture = {"mc.slab.brick.grey"} } )

mc( 44,  0, { name = "stone slabs", texture = {"mc.slab"}, 
              custom_model = {{0, 0, 0, 15, 15, 7, "mc.slab", "mc.slab.top" }} } )

mc( 44,  1, { name = "sandstone slabs", texture = {"sandstone"}, custom_model = {{0, 0, 0, 15, 15, 7}} } )
mc( 44,  2, { name = "wooden slabs", texture = {"wood"}, custom_model = {{0, 0, 0, 15, 15, 7}} } )
mc( 44,  3, { name = "cobblestone slabs", texture = {"cobblestone"}, custom_model = {{0, 0, 0, 15, 15, 7}} } )
mc( 44,  4, { name = "brick slabs", texture = {"brick.red"}, custom_model = {{0, 0, 0, 15, 15, 7}} } )
mc( 44,  5, { name = "stone brick slabs", texture = {"brick.grey"}, custom_model = {{0, 0, 0, 15, 15, 7}} } )
...
mc( 57,  0, { name = "diamond block", texture = {"mc.diamond"} } )
...
mc( 60,  0, { name = "farmland", texture = {"farmland"} } )
for i=1,8 do
    mc( 60,  i, { name = "farmland."..i, texture = {"farmland.wet"} } )
end
...
mc( 62,  2, { name = "burning furnace", texture = {"furnace_side", "furnace_side", "furnace_front_lit", "furnace_side", "cobblestone", "cobblestone"} } )
mc( 62,  3, { name = "burning furnace", texture = {"furnace_side", "furnace_side", "furnace_side", "furnace_front_lit", "cobblestone", "cobblestone"} } )
mc( 62,  4, { name = "burning furnace", texture = {"furnace_side", "furnace_front_lit", "furnace_side", "furnace_side", "cobblestone", "cobblestone"} } )
mc( 62,  5, { name = "burning furnace", texture = {"furnace_front_lit", "furnace_side", "furnace_side", "furnace_side", "cobblestone", "cobblestone"} } )
...
-- own encoding.  west-north-east-south is 0-3.  Bit 0x8 is clear for the
-- bottom part and set for the top part.  Bit 0x8 is set if the handle is
-- on the right, clear for left.
for i=0,7 do
    mc( 64,  i    , { name = "wooden door", texture = {"door.upper"}, transparency = 0.8 } )
    mc( 64,  i + 8, { name = "wooden door", texture = {"door.lower"} } )
end
...
--
mc( 66,  0, { name = "rail.flat.ns", texture = {"rail.ns"}, transparency = 1.0,
              custom_model = {{ 7, 0, 0, 9, 15, 0, "plain.white"}} } )

mc( 66,  1, { name = "rail.flat.ew", texture = {"rail.ew"}, transparency = 1.0,
              custom_model = {{ 0, 7, 0, 15, 9, 0, "plain.white"}} } )
...
--
mc( 67,  0, { name = "stairs.cobblestone.e", texture = {"cobblestone"},
              custom_model = { {0, 0, 0, 7, 15, 7}, { 8, 0, 0, 15, 15, 15}}  } )

mc( 67,  1, { name = "stairs.cobblestone.w", texture = {"cobblestone"}, 
              custom_model = { {0, 0, 0, 7, 15, 15}, { 8, 0, 0, 15, 15, 7}}  } )

mc( 67,  2, { name = "stairs.cobblestone.n", texture = {"cobblestone"},
              custom_model = { {0, 0, 0, 15, 7, 7}, { 0, 8, 0, 15, 15, 15}}  } )

mc( 67,  3, { name = "stairs.cobblestone.s", texture = {"cobblestone"},
              custom_model = { {0, 0, 0, 15, 7, 15}, { 0, 8, 0, 15, 15, 7}}  } )
...
--
mc( 68,  2, { name = "wallsign.e", texture = {"wood"}, custom_model = {{15, 3, 5, 15, 12, 12}} } )
mc( 68,  3, { name = "wallsign.w", texture = {"wood"}, custom_model = {{ 0, 3, 5,  0, 12, 12}} } )
mc( 68,  4, { name = "wallsign.n", texture = {"wood"}, custom_model = {{3, 15, 5, 12, 15, 12}} } )
mc( 68,  5, { name = "wallsign.s", texture = {"wood"}, custom_model = {{3,  0, 5, 12,  0, 12}} } )
...
mc( 70,  0, { name = "stone pressure plate", texture = {"stone.plate"}, custom_model = {{2, 2, 0, 13, 13, 1}}, transparency = 0.9 } )
mc( 70,  1, { name = "stone pressure plate (pressed)", texture = {"stone.plate"}, custom_model = {{2, 2, 0, 13, 13, 0}}, transparency = 0.9 } )

for i=0,7 do
    mc( 71,  i  , { name = "iron door", texture = {"door.upper.iron"}, transparency = 0.8 } )
    mc( 71,  i+8, { name = "iron door", texture = {"door.lower.iron"} } )
end

mc( 72,  0, { name = "wooden pressure plate", texture = {"wood.plate"}, custom_model = {{2, 2, 0, 13, 13, 1}}, transparency = 0.9 } )
mc( 72,  1, { name = "wooden pressure plate (pressed)", texture = {"wood.plate"}, custom_model = {{2, 2, 0, 13, 13, 0}}, transparency = 0.9 } )
...
mc( 77,  1, { name = "button.stone.e", texture = {"stone"}, custom_model = {{0, 6, 6, 1, 10, 10}}, transparency = 0.9 } )
mc( 77,  2, { name = "button.stone.w", texture = {"stone"}, custom_model = {{14, 6, 6, 15, 10, 10}}, transparency = 0.9 } )
mc( 77,  3, { name = "button.stone.s", texture = {"stone"}, custom_model = {{6, 14, 6, 10, 15, 10}}, transparency = 0.9 } )
mc( 77,  4, { name = "button.stone.n", texture = {"stone"}, custom_model = {{6, 0, 6, 10, 1, 10}}, transparency = 0.9 } )
mc( 77,  1, { name = "button.stone.e.pressed", texture = {"stone"}, custom_model = {{0, 6, 6, 0, 10, 10}}, transparency = 0.9 } )
mc( 77,  2, { name = "button.stone.w.pressed", texture = {"stone"}, custom_model = {{15, 6, 6, 15, 10, 10}}, transparency = 0.9 } )
mc( 77,  3, { name = "button.stone.s.pressed", texture = {"stone"}, custom_model = {{6, 15, 6, 10, 15, 10}}, transparency = 0.9 } )
mc( 77,  4, { name = "button.stone.n.pressed", texture = {"stone"}, custom_model = {{6, 0, 6, 10, 0, 10}}, transparency = 0.9 } )
...
for i=0,15 do
    mc( 84,  i, { name = "jukebox", texture = {"mc.musicblock", "mc.jukebox"} } )
end
...
mc( 90,  0, { name = "portal", texture = {"mc.portal"}, transparency = 0.8 } )
...
mc(116,  0, { name = "enchantment table", texture = {"mc.enchantment_side", "mc.enchantment_top", "mc.enchantment_bottom"} } )
...
mc(129,  0, { name = "emerald ore", texture = { "ore.emerald" } } )
mc(133,  0, { name = "emerald block", texture = { "emerald" } } )
