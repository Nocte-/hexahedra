//---------------------------------------------------------------------------
// server/lua_heightmap_generator.cpp
//
...
lua_heightmap_generator::lua_heightmap_generator(world& w, lua& scripting)
    : area_generator_i (w, "heightmap")
    , lua_ (scripting)
{ }
...
area_data&
lua_heightmap_generator::generate (map_coordinates pos, area_data& dest)
{
