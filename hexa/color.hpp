...
//
// Copyright (C) 2012-2014, nocte@hippie.nu
//---------------------------------------------------------------------------
#pragma once
...
public:
    ...
    float* as_ptr() { return reinterpret_cast<float*>(this); }
...
inline const color operator*(color lhs, color rhs)
{
    return lhs *= rhs;
}

inline const color operator*(color lhs, color::value_type rhs)
{
    return lhs *= rhs;
}

inline const color operator*(color::value_type lhs, color rhs)
{
    return rhs *= lhs;
}
...
inline const color_alpha operator*(color_alpha lhs, const color_alpha& rhs)
{
    return lhs *= rhs;
}

inline const color_alpha operator*(color_alpha lhs,
                                   color_alpha::value_type rhs)
{
    return lhs *= rhs;
}

inline const color_alpha operator*(color_alpha::value_type lhs,
                                   color_alpha rhs)
{
    return rhs *= lhs;
}
...
inline ostream& operator<<(ostream& str, const hexa::color& col)
{
    return str << '(' << col.r() << ';' << col.g() << ';' << col.b() << ')';
}

inline ostream& operator<<(ostream& str, const hexa::color_alpha& col)
{
    return str << '(' << col.r() << ';' << col.g() << ';' << col.b() << ';'
               << col.a() << ')';
}
