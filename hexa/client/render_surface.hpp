...
public:
    ...
    element& operator()(chunk_index i, uint8_t dir)
    {
        ...
        switch (dir) {
        case 0:
            p = chunk_index(i.y, i.z, i.x);
            break;
        case 1:
            p = chunk_index(15 - i.y, i.z, 15 - i.x);
            break;
        case 2:
            p = chunk_index(15 - i.x, i.z, i.y);
            break;
        case 3:
            p = chunk_index(i.x, i.z, 15 - i.y);
            break;
        case 4:
            p = chunk_index(i.x, i.y, i.z);
            break;
        case 5:
            p = chunk_index(i.x, 15 - i.y, 15 - i.z);
            break;
        default:
            assert(false);
        }
...
public:
    struct element : public render_surface::element
    {
        ...
        {
            return texture == comp.texture && light_sun == comp.light_sun
                   && light_amb == comp.light_amb
                   && light_art == comp.light_art;
        }
