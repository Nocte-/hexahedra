...
find_library(LEVELDB_LIBRARIES NAMES leveldb PATHS /usr/lib $ENV{LEVELDB_ROOT}/lib DOC "Path to leveldb library." )
mark_as_advanced(LEVELDB_LIBRARIES)

# Copy the results to the output variables.
if (LEVELDB_INCLUDE AND LEVELDB_LIBRARIES)
  message(STATUS "Found leveldb in ${LEVELDB_INCLUDE} ${LEVELDB_LIBRARIES}")
  set(LEVELDB_FOUND 1)
  include(CheckCXXSourceCompiles)
  set(CMAKE_REQUIRED_LIBRARY ${LEVELDB_LIBRARIES} pthread)
...
if (NOT LEVELDB_FOUND)
  set(LEVELDB_DIR_MESSAGE "LEVELDB was not found. Make sure LEVELDB_LIBRARIES and LEVELDB_INCLUDE are set.")
