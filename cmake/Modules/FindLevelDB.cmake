...
if (LEVELDB_INCLUDE_DIR AND LEVELDB_LIBRARIES)
  message(STATUS "Found leveldb in ${LEVELDB_INCLUDE_DIR} ${LEVELDB_LIBRARIES}")
  set(LEVELDB_FOUND 1)
...
if (NOT LEVELDB_FOUND)
  set(LEVELDB_DIR_MESSAGE "LEVELDB was not found. Make sure LEVELDB_LIBRARIES and LEVELDB_INCLUDE_DIR are set.")
